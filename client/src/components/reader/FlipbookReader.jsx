  ...
  return (
    <div ref={wrapRef} className="fixed inset-0 z-50 bg-gray-950 flex flex-col text-white select-none">
      ...
      <div className="flex-1 overflow-hidden relative">
        ...
        /* BASIC MODE: PDF via PDF.js viewer (full text search, better rendering) */
        initData?.pdfUrl ? (
          <iframe
            src={`https://mozilla.github.io/pdf.js/web/viewer.html?file=${encodeURIComponent(initData.pdfUrl)}#page=${reader.currentPage}`}
            title={book?.title}
